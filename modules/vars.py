...
BOT_TOKEN = environ.get("BOT_TOKEN", "8533483302:AAFPd3FONTrRKPHxHkgE9n2ZKCCPH28vYqM")

OWNER = int(environ.get("OWNER", "7071073221"))
CREDIT = environ.get("CREDIT", "🤍🌸@Aanandmauryaup51🤍🌸")
